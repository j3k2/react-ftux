...
var PointerBase = styled.div(_templateObject());
var PointerAbove = styled(PointerBase)(_templateObject2(), function (props) {
  return props.backgroundColor;
});
var PointerBelow = styled(PointerBase)(_templateObject3(), function (props) {
  return props.backgroundColor;
});
var PointerLeft = styled(PointerBase)(_templateObject4(), function (props) {
  return props.backgroundColor;
});
var PointerRight = styled(PointerBase)(_templateObject5(), function (props) {
  return props.backgroundColor;
});
...
var ButtonsContainer = styled.div(_templateObject2$1());
...
var CloseButton = styled.span(_templateObject$2(), function (props) {
  return props.highlightColor;
});
var StyledTooltipBody = styled.div(_templateObject2$2(), function (props) {
...
var ReactFtuxTooltip = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ReactFtuxTooltip, [{
    ...
    key: "render",
    value: function render() {
      var TooltipContent = styled.div(_templateObject$3());
      var TooltipWrapper = styled.div(_templateObject2$3(), function (props) {
