...
var TooltipButton = styled.button(_templateObject6(), function (props) {
...
var CloseButton = styled.span(_templateObject7(), function (props) {
  return props.highlightColor;
});
  ...
  _createClass(ReactFtuxTooltip, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement(TooltipWrapper, {
        ...
        className: "tooltip-pointer ".concat(this.props.pointerDirection),
