...
function (_Component) {
  ...
  function ReactFtux(props) {
    ...
    _this.init = function () {
      ...
      if (!_this.props.tooltipSettings.disableKeydownListener) {
  ...
  _createClass(ReactFtux, [{
    ...
    value: function componentDidMount() {
      ...
      eventEmitter.on(events.FTUX_ACTION_END, function () {
        ...
        if (!_this2.props.tooltipSettings.disableKeydownListener) {
...
var PointerAbove = PointerBase.extend(_templateObject4(), function (props) {
  return props.backgroundColor || 'black';
});
var PointerBelow = PointerBase.extend(_templateObject5(), function (props) {
  return props.backgroundColor || 'black';
});
var PointerLeft = PointerBase.extend(_templateObject6(), function (props) {
  return props.backgroundColor || 'black';
});
var PointerRight = PointerBase.extend(_templateObject7(), function (props) {
  return props.backgroundColor || 'black';
});
