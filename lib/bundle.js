...
function FtuxTooltip(props) {
  ...
  var _React$useState3 = React.useState({
    ...
    backgroundColor: "#000"
      ...
      _React$useState4 = _slicedToArray(_React$useState3, 2),
      tooltipSettings = _React$useState4[0],
      setTooltipSettings = _React$useState4[1];

  var _React$useState5 = React.useState(),
      _React$useState6 = _slicedToArray(_React$useState5, 2),
      offsets = _React$useState6[0],
      setOffsets = _React$useState6[1];
  ...
  React.useEffect(function () {
    if (tooltipProperties) {
      setTooltipSettings(_objectSpread2(_objectSpread2(_objectSpread2({}, tooltipSettings), tooltipProperties), props));
    }
  }, [tooltipProperties]);
