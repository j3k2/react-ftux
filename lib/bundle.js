...
function (_Component) {
  ...
  function ReactFtuxTooltip(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "readTooltipSettings", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "setPosition", function () {
      var tooltipRef = ReactDOM.findDOMNode(_this.refs.tooltip);
  ...
  _createClass(ReactFtuxTooltip, [{
    key: "updateState",
    value: function updateState(updatedFtuxStore) {
    ...
    value: function componentDidMount() {
      ...
      eventEmitter.on(events.FTUX_UPDATER, function (updatedFtuxStore) {
        _this2.updateState(updatedFtuxStore);
      });
      eventEmitter.on(events.FTUX_ACTION_END, function () {
        _this2.updateState({
          currentStep: null
    ...
    value: function render() {
      ...
      if (this.tooltipSettings.last) {
        ...
        }, this.tooltipSettings.prevLabel), React__default.createElement(StyledButton, {
          buttonFontStyle: this.tooltipSettings.fontStyle,
          backgroundColor: this.tooltipSettings.backgroundColor,
          foregroundColor: this.tooltipSettings.foregroundColor,
          highlightColor: this.tooltipSettings.highlightColor,
        ...
        nav = React__default.createElement("div", null, !this.tooltipSettings.first && React__default.createElement(StyledButton, {
          buttonFontStyle: this.tooltipSettings.fontStyle,
          backgroundColor: this.tooltipSettings.backgroundColor,
          foregroundColor: this.tooltipSettings.foregroundColor,
          highlightColor: this.tooltipSettings.highlightColor,
