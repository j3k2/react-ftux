...
function (_Component2) {
  ...
  _createClass(ReactFtuxTooltip, [{
    ...
    value: function render() {
      ...
      if (this.state.last) {
        buttons = _react.default.createElement("div", null, _react.default.createElement("button", _extends({}, buttonStyle, anchorStyle, {
          onClick: this.state.triggerDecreaseStep
        }), "Previous"), _react.default.createElement("button", _extends({}, buttonStyle, anchorStyle, {
          onClick: this.state.triggerEndFtux
        }), "Done"));
      } else {
        buttons = _react.default.createElement("div", null, !this.state.first && _react.default.createElement("button", _extends({}, buttonStyle, anchorStyle, {
          onClick: this.state.triggerDecreaseStep
        }), "Previous"), _react.default.createElement("button", _extends({}, buttonStyle, anchorStyle, {
      ...
      }, this.props.children), _react.default.createElement("span", _extends({}, anchorStyle, {
        style: {
          position: 'absolute',
          top: 0,
          right: 10
