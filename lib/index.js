...
function (_Component2) {
  ...
  _createClass(ReactFtuxTooltip, [{
    key: "updateState",
    value: function updateState(stepState, stepConfig, hide) {
    ...
    value: function componentDidMount() {
      ...
      events.on(FTUX_ACTION_END, function () {
        _this4.updateState(store.stepState, store.stepConfig, true);
      });
      events.trigger(FTUX_REDUCER_STEP, [store.stepState, store.stepConfig]);
    }
  }, {
    ...
    value: function render() {
      ...
      }, _react.default.createElement("span", null, this.state.stepTitle), _react.default.createElement("p", null, this.state.stepContent)), _react.default.createElement("div", {
        style: {
          float: "right"
        }
      }, buttons)));
