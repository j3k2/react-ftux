...
var StyledAnchor = _styledComponents.default.span(_templateObject2());
...
function (_Component2) {
  ...
  _createClass(ReactFtuxTooltip, [{
    ...
    value: function render() {
      ...
      if (this.state.last) {
        buttons = _react.default.createElement("div", null, _react.default.createElement(StyledButton, {
          onClick: this.state.triggerDecreaseStep
        }, "Previous"), _react.default.createElement(StyledButton, {
          onClick: this.state.triggerEndFtux
        }, "Done"));
      } else {
        buttons = _react.default.createElement("div", null, !this.state.first && _react.default.createElement(StyledButton, {
          onClick: this.state.triggerDecreaseStep
        }, "Previous"), _react.default.createElement(StyledButton, {
      ...
      }, this.props.children), this.state.disableCloseButton ? null : _react.default.createElement(StyledAnchor, {
        style: {
          position: 'absolute',
          top: 0,
          right: 6
